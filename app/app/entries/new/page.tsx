...
export default function NewEntryPage() {
  ...
  // ---- helpers with explicit types (avoid implicit any) ----
  ...
  const onLabelDragOver = (e: React.DragEvent<HTMLLabelElement>) => {
    e.preventDefault();
    setDragOver(true);
  };
  const onLabelDragLeave = () => setDragOver(false);
  const onLabelDrop = (e: React.DragEvent<HTMLLabelElement>) => {
    e.preventDefault();
    e.stopPropagation();
    setDragOver(false);
